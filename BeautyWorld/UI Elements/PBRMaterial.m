...
+ (SCNMaterial *)materialNamed:(NSString *)name {
  ...
  mat.diffuse.contents = [UIImage imageNamed:[NSString stringWithFormat:@"./Models.scnassets/Materials/%@/%@-albedo.png", name, name]];
  mat.roughness.contents = [UIImage imageNamed:[NSString stringWithFormat:@"./Models.scnassets/Materials/%@/%@-roughness.png", name, name]];
  mat.metalness.contents = [UIImage imageNamed:[NSString stringWithFormat:@"./Models.scnassets/Materials/%@/%@-metal.png", name, name]];
  mat.normal.contents = [UIImage imageNamed:[NSString stringWithFormat:@"./Models.scnassets/Materials/%@/%@-normal.png", name, name]];
